...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex h-full w-full bg-white flex-col overflow-hidden rounded-md",
        className
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-none focus:ring-0 focus:outline-none border-none disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
